...
const (
	...
	ModelRegistryDeploymentPath         = "./test/data/modelregistry_deployment.yaml"
	ModelRegistryDatabaseDeploymentPath = "./test/data/modelregistry_db_deployment.yaml"
	ServingRuntimePath1                 = "./test/data/kserve-openvino-serving-runtime-1.yaml"
	InferenceServicePath1               = "./test/data/kserve-openvino-inference-service-1.yaml"
